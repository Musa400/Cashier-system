...
<Card
  ...
  className="rounded-2xl shadow-md w-full sm:w-1/3" // کوچنۍ عرض
  style={{
    background: "linear-gradient(to bottom, #f0fdf4, #ffffff)", // سپین + شین
    border: "1px solid #d1fae5", // نری شین بارډر
  }}
  headStyle={{
    textAlign: "center",
    fontWeight: "bold",
